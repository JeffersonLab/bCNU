...
//	public static final String DC_SUPLAY5_LAY2 = "DC_Suplay5_Lay2";
	...
	public static final String SHOW_FMT_CLUSTERS = "FMT Clusters";
	public static final String SHOW_FMT_TRAJECTORIES = "FMT Trajectory";
	...
	/** Show reconstructed FMT cluster seed strips? */
	public boolean showFMTClusters() {
		return show(PlainPanel3D.SHOW_FMT_CLUSTERS);
	}

	/** Show FMT trajectory positions? */
	public boolean showFMTTrajectories() {
		return show(PlainPanel3D.SHOW_FMT_TRAJECTORIES);
	}
