...
/** Read-through access to the current {@code BMTRec::Clusters} bank. */
public final class BMTClusters {

    private static final String BANK_NAME = "BMTRec::Clusters";
