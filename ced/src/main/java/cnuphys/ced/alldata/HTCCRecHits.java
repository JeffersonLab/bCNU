...
/** Read-through access to the current {@code HTCC::rec} bank. */
public final class HTCCRecHits {

    public static final String BANK_NAME = "HTCC::rec";
    private static final HTCCRecHits INSTANCE = new HTCCRecHits(
    ...
    private HTCCRecHits(Supplier<DataBank> bankSupplier, Supplier<Object> eventSupplier) {
        this.bankSupplier = bankSupplier;
        this.eventSupplier = eventSupplier;
    }

    static HTCCRecHits forTesting(Supplier<DataBank> bankSupplier) {
        Object event = new Object();
        return new HTCCRecHits(bankSupplier, () -> event);
    }

    public static HTCCRecHits getInstance() { return INSTANCE; }
    ...
    public void addFeedback(int row, List<String> feedback) {
        String text = String.format("$Orange Red$HTCC id %d hit loc (%5.2f, %5.2f, %5.2f) cm",
